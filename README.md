...
### How to use the "Game Reward" functionality

The "Reward yourself with a game!" functionality allows you to launch a game after finishing the configured amount of Post-Its.
You can either let the application choose one randomly for you, or you can click on any game card.

In order to use it, you need an API key.
It can be generated by filling this [form](https://steamcommunity.com/dev/apikey) (the domain name can be anything, you don't actually need one).

After getting the key, at the root of the project, create a file called ".env.local".
This file can contain environment variables that are considered sensitives, like API keys. 
By default, this file is ignored by Git, and as the name says, stays local to you and your machine.
In this file, type `STEAM_API_KEY=<insert your key here>`. And voilà! You can use the functionality.
