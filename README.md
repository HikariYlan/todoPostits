...
The "Pick a random game!" functionality allows you to choose randomly from your Steam account.
...
The only thing your SteamID is used for is to get all of your owned games to select one randomly.
